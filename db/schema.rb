...
ActiveRecord::Schema.define(version: 20161107194339) do
  ...
  create_table "userplayers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["player_id"], name: "index_userplayers_on_player_id", using: :btree
    t.index ["user_id"], name: "index_userplayers_on_user_id", using: :btree
  end
